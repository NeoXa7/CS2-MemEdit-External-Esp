...
namespace Settings
{
	...
	namespace Aimbot
	{
		...
		float aim_fov = menu_items::aimbot_fov_slider_value; // Field of view in degrees, adjust this value as needed
		float aim_smooth_Factor = 1.f; // Adjust this value to change smoothness, lower is smoother

		Vector3 SetLowerBodyCoordinates(Vector3 entityPosition, uintptr_t entityPawn)
		{
	...
	namespace glow_hack
	{
		...
		namespace glow_cfg
		{
			...
			inline bool glow_after_entity_is_Dead = false;
		}
	...
	{
		inline int FIRE_KEY = menu_items::keyCode_triggerBot;
	...
	namespace RCS
	{
		float sensitivity = menu_items::rcs_sesni_input_value;
