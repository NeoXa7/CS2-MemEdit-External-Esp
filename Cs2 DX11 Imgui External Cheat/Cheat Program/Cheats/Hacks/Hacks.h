...
{
	view_matrix_t viewMatrix = Memory::ReadMemory<view_matrix_t>(CS2::clientAddress + Offsets::dwViewMatrix);
	...
	for (int i = 0; i < 64; i++)
	{
		...
		if (WorldToScreen(playerPosition, screenPos, viewMatrix, Screen_WIDTH, Screen_HEIGHT) &&
			WorldToScreen(headPosition, headScreenPos, viewMatrix, Screen_WIDTH, Screen_HEIGHT))
		{
